    ...
    <div class="table-container">
      ...
      >
        ...
        <el-table-column label="操作" width="80" align="center">
          <template slot-scope="scope">
            <el-button type="text" @click="handleViewUserWordDetail(scope.$index, scope.row)">查看单词</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    ...
    addUserWord() {
      ...
      this.userWord = Object.assign({}, defaultUserWord);
    },
    focusInputEnter() {
      this.handleSearchList();
    },
    handleViewUserWordDetail(index, row) {
      // this.$router.push(path);
      this.$router.push({path:'/study/card/userWordView',query:{id:row.id}});
    },
    errorHandler() {
      return true
    }
